...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath}/resources/assets/user/assets/css/bootstrap.min.css"/>

    <!-- Font Awesome Icon -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/resources/assets/user/assets/css/font-awesome.min.css">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath}/resources/assets/user/assets/css/style.css"/>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand">
                <a class="logo" href="/">
                    <img width="100"
                         src="${pageContext.request.contextPath}/resources/assets/user/assets/img/logo-alt.png"
                         alt="logo">
                </a>
            </div>
            <!-- /Logo -->
            ...
            <div class="col-md-6">
                <div class="footer-logo">
                    <a class="logo" href="index.html">
                        <img src="${pageContext.request.contextPath}/resources/assets/user/assets/img/logo-alt.png"
                             alt="logo">
                    </a>
                </div>
            </div>
...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/assets/user/assets/js/jquery.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/assets/user/assets/js/bootstrap.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resources/assets/user/assets/js/main.js"></script>
<script>
    function reply() {
