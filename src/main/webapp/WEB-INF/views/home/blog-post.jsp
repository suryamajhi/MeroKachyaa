...
<div class="hero-area section">
	...
	<!-- Backgound Image -->
	<div class="bg-image bg-parallax overlay" style="background-image:url(.${pageContext.request.contextPath}/resources/assets/user/assets/img/blog-post-background.jpg)"></div>
	<!-- /Backgound Image -->
					...
					<c:forEach items="${blog.commentsById}" var="comment">
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<p>${comment.content}</p>
								<div class="date-reply"><span>${comment.date}</span><a onclick="reply()" href="#" class="reply">Reply</a></div>
								<!-- comment reply form -->
