        ...
        <div class="row">
                ...
                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist"
                    ...
                    <c:forEach items="${chapters}" var="chapter">
                        ...
                        <c:forEach items="${chapter.lessonsById}" var="lesson">
                            <a class="nav-link " id="vert-tabs-${chapter.id}-${lesson.id}-tab" data-toggle="pill"
                               href="#vert-tabs-${chapter.id}-${lesson.id}" role="tab"
                               aria-controls="vert-tabs-${chapter.id}-${lesson.id}"
                               aria-selected="true">${lesson.serial} : ${lesson.title}</a>
                        </c:forEach>
                    </c:forEach>
                </div>
            </div>
            <div class="col-7 col-sm-9">
                <div class="tab-content" id="vert-tabs-tabContent">
                    ...
                    <c:forEach items="${chapters}" var="chapter">
                        <c:forEach items="${chapter.lessonsById}" var="lesson">
                            <div class="tab-pane text-left fade " id="vert-tabs-${chapter.id}-${lesson.id}"
                                 role="tabpanel" aria-labelledby="vert-tabs-${chapter.id}-${lesson.id}-tab">
                                    ${lesson.content}
                                        ...
                                        <div class="blog-comments">
                                            <c:forEach items="${lesson.discussions}" var="discussion">
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <img src="data:image/jpg;base64,${discussion.userByUserId.base64Image}"
                                                             alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4 class="media-heading">${discussion.userByUserId.name}</h4>
                                                        <p>${discussion.content}</p>
                                                        <div class="date-reply"><span>${discussion.date}</span><a
                                                                onclick="reply()" href="#" class="reply">Reply</a></div>
                                                        <!-- comment reply form -->
                                                    ...
                                                    <div id="replyBlock" style="display: none;" class="blog-reply-form">
                                                        ...
                                                        <form action="/discussion/${discussion.id}/reply" method="post">
                                                            ...
                                                            <button class="main-button icon-button" type="submit">
                                                                Submit
                                                            </button>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <c:forEach items="${discussion.discussionReplyById}" var="reply">
                                                        ...
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <img src="data:image/jpg;base64,${reply.userByUserId.base64Image}"
                                                                     alt="">
                                                            </div>
                                                            <div class="media-body">
                                                                <h4 class="media-heading">${reply.userByUserId.name}</h4>
                                                                <p>${reply.content}</p>
                                                                <div class="date-reply"><span>${reply.date}</span><a
                                                                        href="#" class="reply">Reply</a></div>
                                                            </div>
                                                        </div>
                                                        <!-- /comment reply -->
                                                    </c:forEach>
                                            ...
                                            <div class="blog-reply-form">
                                                ...
                                                <form action="/lesson/${lesson.id}/discussion" method="post">
                                                    <textarea class="input" name="content"
                                                              placeholder="Enter your Message"></textarea>
                                                    <button class="main-button icon-button" type="submit">Submit
                                                    </button>
                                                </form>
                                            </div>
                                            <!-- /blog reply form -->
