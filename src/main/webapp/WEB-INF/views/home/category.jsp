    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 text-center">
                ...
                <h1 class="white-text">Category Page</h1>
                            ...
                            <div class="single-blog">
                                <div class="blog-img">
                                    <a href="/blog/${category.id}">
                                        <img src="data:image/jpg;base64,${category.base64Image}" alt="">
                                    </a>
                                </div>
                                <h4><a href="/category/${category.id}">${category.name}</a></h4>
                                <div class="blog-meta">
                                    <div class="pull-right">
                                        <span class="blog-meta-comments"><a href="#"><i class="fa fa-comments"></i> 12 courses</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
