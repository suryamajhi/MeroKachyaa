...
<div id="home" class="hero-area">
    ...
    <div class="bg-image bg-parallax overlay"
         style="background-image:url(.${pageContext.request.contextPath}/resources/assets/user/assets/img/home-background.jpg)"></div>
    <!-- /Backgound Image -->
                        ...
                        <div class="course">
                            ...
                            <div class="course-details">
                                <span class="course-category"><a
                                        href="/category/${course.categoryId}">${course.categoryByCategoryId.name}</a></span>
...
<div id="cta" class="section">
    ...
    <!-- Backgound Image -->
    <div class="bg-image bg-parallax overlay"
         style="background-image:url(.${pageContext.request.contextPath}/resources/user/assets/img/cta1-background.jpg)"></div>
    <!-- /Backgound Image -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p class="lead white-text">Ceteros fuisset mei no, soleat epicurei adipiscing ne vis. Et his suas veniam
                    nominati.</p>
                <a class="main-button icon-button" href="#">Get Started!</a>
            </div>
...
<div id="contact-cta" class="section">
    ...
    <!-- Backgound Image -->
    <div class="bg-image bg-parallax overlay"
         style="background-image:url(.${pageContext.request.contextPath}/resources/user/assets/img/cta2-background.jpg)"></div>
    <!-- Backgound Image -->
