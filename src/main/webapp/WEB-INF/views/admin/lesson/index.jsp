                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <c:forEach items="${lessons}" var="lesson">
                                <tr>
                                    ...
                                    <td><a href="/admin/lesson/${lesson.id}"><button class="btn btn-primary">View lesson</button></a></td>
                                    <td><a class="btn btn-primary" href="/admin/lesson/edit/${lesson.id}">Edit</a></td>
                                    <td><a class="btn btn-danger" href="/admin/lesson/delete/${lesson.id}">Delete</a></td>
                                </tr>
                            </c:forEach>
